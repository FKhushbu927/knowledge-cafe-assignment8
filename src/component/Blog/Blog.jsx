...
const SingleCard = ({ blog,  handleAddToBookMark}) => {
   
    return (
        <>
            <div className="cover-image m-auto ">
                <img className='rounded my-2' style={{ height: "400px", width: "750px" }} src={blog.cover} alt="" />
            </div>
            ...
            <div className='mx-5 my-4 d-flex justify-content-between'>
                ...
                <div className='timeAndBookmark d-flex justify-content-between'>
                    ...
                    <span onClick={() => handleAddToBookMark(blog)}><FontAwesomeIcon icon={faBookmark} /></span>
                </div>
            </div>
